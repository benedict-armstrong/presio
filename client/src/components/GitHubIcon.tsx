// The GitHub mark as an inline SVG: lucide-react ships no brand icons, and one
// glyph is not worth another dependency. Decorative by default — give the
// wrapping link the accessible name.
